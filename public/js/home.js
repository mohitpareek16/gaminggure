...
function populate(s1, s2) {
    ...
    if (s1.value == "FORTNITE") {
        var optionArray = ['SKILLS ASSESSMENT|SKILLS ASSESSMENT', 'ONE-ON-ONE TRAINING|ONE-ON-ONE TRAINING', 'TEAM SESSION|TEAM SESSION'];
...
function populate2(s1, s2) {
    ...
    if (s1.value == "TEAM SESSION") {
        var optionArray = ['LEGENDARY|LEGENDARY', 'EXPERT|EXPERT', 'ADVANCED|ADVANCED', 'STANDARD|STANDARD'];
