...
function cartNumbers(product) {
    ...
    if (productNumbers) {
        ...
        document.querySelector('.nav-top .nav-centre span').textContent = productNumbers + 1;
    } else {
...
function validCard() {
    ...
    if (success == 1) {
        ...
        alert(`You Done something wrong, Please Try Again To confirm The Payment of $${finalPrice} `)
    }
